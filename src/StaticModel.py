...
class StaticModel(nn.Module):
    ...
    def forward(self, text_features, audio_features, visual_features):
        ...
        text_emb = torch.relu(self.text_norm(self.text_encoder(text_features)))
        audio_emb = torch.relu(self.audio_norm(self.audio_encoder(audio_features)))
        visual_emb = torch.relu(self.visual_norm(self.visual_encoder(visual_features)))
        ...
        fused_hidden = torch.relu(self.fusion_norm(self.fusion_layer(fused_features)))
